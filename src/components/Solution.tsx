    ...
    <section className="py-20 px-4 bg-gradient-to-br from-cyan-50 to-blue-50">
      <div className="container mx-auto">
        <h2 className="text-3xl md:text-5xl font-bold text-center mb-4 text-gray-900">
          A Solução: Secretária com IA Humanizada
        </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-bold mb-3 text-gray-900">Secretária com IA</h3>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-bold mb-3 text-gray-900">Fluxos de agendamentos otimizados</h3>
            <p className="text-gray-700">
